...
core_load_fruits_freeze_models()  # 加载模型
name_dict1 = {"MT_Blowhole": 0,
             "MT_Break": 1,
             "MT_Crack": 2,
             "MT_Fray": 3,
             "MT_Free": 4,
...
name_dict2 = {"apple": 0, "banana": 1, "grape": 2,
             "orange": 3, "pear": 4}
...
def show_infer(request):
    return render(request,'fruit_infer/infer_index.html')