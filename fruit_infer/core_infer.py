...
# 加载模型
def core_load_fruits_freeze_models():
    print("core_load_fruits_freeze_models()")
    ...
    infer_program, feed_names, fetch_targets = fluid.io.load_inference_model(fruits_freeze_model_dir,
                                                                             exe)
    print("完成水果模型加载")
